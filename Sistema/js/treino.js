$(function() {
    ...
    $("#btnExerc").click(function() {
        ...
        var dia = "dia" + cont;
        $("#divBtn").append("<hr><div class='row'><div class='form-group col-md-3'><label>Nome do exercicio: </label><input id=" + nome + "' name=" + nome + " type='text' placeholder='Nome do exercicio' class='form-control input-md' required=''>" +
            ...
            "<div class='form-group col-md-3'><label>Dia da semana: </label><input id=" + dia + " name=" + dia + " type='text' placeholder='Dia da semana' class='form-control input-md' required=''></div></div>");
