...
$query->execute();
$avaliacao = $query->fetchAll(PDO::FETCH_ASSOC);

$sql = "SELECT * FROM trein_usua_aval WHERE id_avaliacao = $id";
$query = $conexao->prepare($sql);
$query->execute();
$tua = $query->fetchAll(PDO::FETCH_ASSOC);

$sql = "SELECT * FROM medidas WHERE id_avaliacao = $id";
$query = $conexao->prepare($sql);
$query->execute();
